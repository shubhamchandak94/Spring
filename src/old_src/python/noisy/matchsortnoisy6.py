#Reordering for noisy reads without RC. 4 dictionaries (ind). Tries to find best match for all shifts upto maxmatch.
#Otherwise same as matchsortnoisy2.py
#Does very badly - too many hard reads.
