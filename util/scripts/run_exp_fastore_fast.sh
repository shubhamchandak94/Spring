...
outputname_lossless=/raid/shubham/HARC/data/SRR554369_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
...
outputname_lossless=/raid/shubham/HARC/data/ERR532393_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
...
outputname_lossless=/raid/shubham/HARC/data/SRR870667_2_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1  --out $outputname_lossless --verbose |& tee -a $logname
...
outputname_lossless=/raid/shubham/HARC/data/NA12878-Rep-1_S1_S2.trimmed_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
...
outputname_lossless=/raid/shubham/HARC/data/NA12878-Rep-1_S1_L001.trimmed_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
...
outputname_lossless=/raid/shubham/HARC/data/HS_28_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
...
outputname_lossless=/raid/shubham/HARC/data/SRR062634_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
...
outputname_lossless=/raid/shubham/HARC/data/PhiX_100M_lossless_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossless --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossless --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossless -o"$file_1".lossless.d" $file_2".lossless.d"" -v -t8 |& tee -a $logname
rm $file_1".lossless.d" $file_2".lossless.d"
