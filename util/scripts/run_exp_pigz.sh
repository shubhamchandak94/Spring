...
stdbuf -oL /usr/bin/time -v ./../pigz-2.4/pigz -p 8 $file_1 $file_2 |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../pigz-2.4/unpigz -p 8 -k $file_1".gz" $file_2".gz" |& tee -a $logname
...
stdbuf -oL /usr/bin/time -v ./../pigz-2.4/pigz -p 8 $file_1 |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../pigz-2.4/unpigz -p 8 -k $file_1".gz" |& tee -a $logname
