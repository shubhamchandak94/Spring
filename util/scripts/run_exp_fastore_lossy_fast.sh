...
outputname_lossy=/raid/shubham/HARC/data/SRR554369_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_old --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
...
outputname_lossy=/raid/shubham/HARC/data/ERR532393_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_old --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
...
outputname_lossy=/raid/shubham/HARC/data/SRR870667_2_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_old --fast --threads 8 --in $file_1  --out $outputname_lossy --verbose |& tee -a $logname
...
outputname_lossy=/raid/shubham/HARC/data/NA12878-Rep-1_S1_S2.trimmed_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_novaseq --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
...
outputname_lossy=/raid/shubham/HARC/data/NA12878-Rep-1_S1_L001.trimmed_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_novaseq --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
...
outputname_lossy=/raid/shubham/HARC/data/HS_28_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_old --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
...
outputname_lossy=/raid/shubham/HARC/data/SRR062634_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_old --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
...
outputname_lossy=/raid/shubham/HARC/data/PhiX_100M_lossy_fast.fastore
stdbuf -oL /usr/bin/time -v ./../FaStore/scripts/fastore_compress.sh --lossy_novaseq --fast --threads 8 --in $file_1 --pair $file_2  --out $outputname_lossy --verbose |& tee -a $logname
stdbuf -oL /usr/bin/time -v ./../FaStore/bin/fastore_pack d -z -i$outputname_lossy -o"$file_1".lossy.d" $file_2".lossy.d"" -v -t8 |& tee -a $logname
rm $file_1".lossy.d" $file_2".lossy.d"
